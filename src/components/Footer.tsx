...
const socialLinks = [
  ...
  { name: "X", url: "https://x.com/alivegoal", icon: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" },
  ...
  const columns = lang === "pt"
    ? [
        ...
        },
        {
          ...
          links: [
            { label: "Palpites de Hoje", href: "#predictions" },
    ...
    : [
        ...
        },
        {
          ...
          links: [
            ...
            { label: "Telegram Channel", href: "https://t.me/alivegoal" },
          ],
        },
        {
          title: "Popular Markets",
          links: [
            { label: "BTTS (Both Teams to Score)", href: "#predictions" },
            { label: "Over 2.5 Goals", href: "#predictions" },
            { label: "Over 1.5 Goals", href: "#predictions" },
            { label: "Match Result", href: "#predictions" },
            { label: "Accumulators", href: "#predictions" },
          ],
        },
        {
          title: "Legal",
      ...
      <div className="container">
        ...
        <div className="mb-10 max-w-4xl">
          <h3 className="font-display text-xl font-bold mb-3">
            {lang === "pt"
              ? "ALIVEGOAL — Tips de Apostas de Futebol Grátis"
              : "ALIVEGOAL — Free Football Betting Tips"}
          </h3>
          <p className="text-sm text-muted-foreground leading-relaxed">
            {lang === "pt"
              ...
              : "AliveGoal is your free football betting tips platform. We publish daily predictions with statistical analysis for the main competitions: Champions League, Premier League, La Liga, Serie A, Bundesliga, Liga Portugal and African leagues such as Moçambola. Our tips cover markets like BTTS, Over/Under, Match Result and accumulators, always with updated odds and confidence levels. Follow our Telegram channel @alivegoal to get tips first."}
          </p>
        </div>
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div>
            <h4 className="font-display mb-3 font-bold">
              {lang === "pt" ? "Newsletter" : "Newsletter"}
            </h4>
            <p className="text-xs text-muted-foreground mb-2">
              {lang === "pt"
                ? "Recebe tips diárias no teu email — grátis."
                : "Get daily tips in your email — free."}
            </p>
            <form className="space-y-2" onSubmit={(e) => e.preventDefault()}>
              <Input
                ...
                aria-label={lang === "pt" ? "Email para newsletter" : "Newsletter email"}
              />
            ...
            <h4 className="font-display mt-6 mb-3 font-bold">
              {lang === "pt" ? "Segue-nos" : "Follow Us"}
            </h4>
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  title={social.name}
                  aria-label={`Follow ALIVEGOAL on ${social.name}`}
                >
        ...
        <div className="mt-10 border-t border-border pt-6 text-center text-xs text-muted-foreground">
          <p className="mb-2">
            {lang === "pt" ? (
              ...
              <><strong>Affiliate Disclosure:</strong> ALIVEGOAL may receive commissions from bookmaker partners. This does not affect our analysis or recommendations.</>
            )}
          </p>
          <p>
            &copy; {new Date().getFullYear()} ALIVEGOAL.{" "}
            {lang === "pt"
              ? "Todos os direitos reservados. | 18+ | Por favor, joga de forma responsável."
              : "All rights reserved. | 18+ | Please gamble responsibly."}
          </p>
        </div>
      </div>
    </footer>
