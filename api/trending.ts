...
// Notícias curadas — atualizadas 10/05/2026 (noite)
const CURATED_TRENDING: TrendingItem[] = [
  {
    ...
    summary: "HISTÓRICO! O Barcelona goleou o Real Madrid por 2-0 no Camp Nou e sagrou-se campeão da La Liga com 3 jornadas de antecedência! Rashford abriu o marcador aos 9' de livre direto e Ferran Torres fez o 2-0 aos 18' com assistência de Dani Olmo. Real Madrid humilhado em casa do rival. Hansi Flick conquista a La Liga no seu primeiro ano no Barcelona. Festa épica no Camp Nou!",
    summary_en: "HISTORIC! Barcelona thrashed Real Madrid 2-0 at Camp Nou and were crowned La Liga champions with 3 games to spare! Rashford opened the scoring at 9' with a direct free-kick and Ferran Torres made it 2-0 at 18' with an assist from Dani Olmo. Real Madrid humiliated at their rivals' ground. Hansi Flick wins La Liga in his first year at Barcelona. Epic celebrations at Camp Nou!",
    tag: "BREAKING",
    source: "@LaLiga",
  ...
  {
    id: "t2",
    title: "💥 CRISE NO MILAN! Atalanta vence 3-2 em San Siro — Milan pode FICAR FORA da Champions!",
    title_en: "💥 MILAN CRISIS! Atalanta win 3-2 at San Siro — Milan could MISS OUT on Champions League!",
    summary: "Desastre total para o AC Milan! A Atalanta venceu por 3-2 no San Siro num jogo louco e o Milan caiu para o 4º lugar empatado com a Roma. Com 2 jornadas para o fim, a qualificação para a Champions League está em risco máximo. Gasperini continua a sua magia — Atalanta em 3º lugar e a sorrir. A crise de Fonseca no Milan atinge o ponto mais crítico da época.",
    summary_en: "Total disaster for AC Milan! Atalanta won 3-2 at San Siro in a crazy game and Milan dropped to 4th place level on points with Roma. With 2 games left, Champions League qualification is at maximum risk. Gasperini continues his magic — Atalanta in 3rd place and smiling. Fonseca's crisis at Milan reaches the most critical point of the season.",
    tag: "HOT",
    source: "@SerieA",
    url: "https://x.com/alivegoal",
    time: "10/05/2026",
