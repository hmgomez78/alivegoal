...
function parseTipsFromHTML(html: string): Tip[] {
  ...
  const todayStr = today.toISOString().split('T')[0]; // e.g. "2026-07-01"
...
// Fallback tips — 01/07/2026 — 16 Avos de Final
function getFallbackTips(): Tip[] {
  const dateStr = '01/07/2026';
  return [
    // ===== 16 AVOS DE FINAL: INGLATERRA vs CONGO-DR =====
    {
      id: 1001,
      betNumber: '1001',
      betType: 'SINGLE',
      ...
      winner: 'Inglaterra',
      analysis: '🏴󠁧󠁢󠁥󠁮󠁧󠁿 Inglaterra vs Congo-DR 🇨🇩 Vitória Inglaterra & +1.5 Golos @1.45 — A Inglaterra de Bellingham e Kane é uma das grandes favoritas ao título. O Congo-DR fez história ao qualificar-se, mas a diferença de qualidade é enorme. Bellingham está em excelente forma e Kane precisa de marcar. Esperamos uma vitória inglesa confortável com pelo menos 2 golos.',
      homePercent: 78,
      drawPercent: 13,
      awayPercent: 9,
    },
    // ===== 16 AVOS DE FINAL: BÉLGICA vs SENEGAL =====
    {
      id: 1002,
      betNumber: '1002',
      betType: 'SINGLE',
      ...
      market: 'Ambas Marcam',
      winner: '',
      analysis: '🇧🇪 Bélgica vs Senegal 🇸🇳 Ambas Marcam @1.90 — A Bélgica tem um ataque poderoso com De Bruyne e Lukaku, mas o Senegal de Sadio Mané é uma equipa muito perigosa nas transições. O Senegal marcou em todos os jogos da fase de grupos. Prevemos um jogo aberto com golos de ambos os lados.',
      homePercent: 50,
      drawPercent: 25,
      awayPercent: 25,
    },
    // ===== 16 AVOS DE FINAL: EUA vs BÓSNIA-HERZEGOVINA =====
    {
      id: 1003,
      betNumber: '1003',
      betType: 'SINGLE',
      ...
      winner: 'EUA',
      analysis: '🇺🇸 EUA vs Bósnia-Herzegovina 🇧🇦 Vitória EUA @1.55 — Os EUA jogam em casa e têm o apoio do público americano. Com Pulisic, McKennie e Reyna em forma, os anfitriões são favoritos. A Bósnia surpreendeu ao qualificar-se, mas os EUA têm mais qualidade individual e o fator casa. Uma vitória americana é o resultado mais provável.',
      homePercent: 58,
      drawPercent: 22,
      awayPercent: 20,
    },
    // ===== ANÁLISE ANTECIPADA: PORTUGAL vs CROÁCIA (2 JUL) =====
    {
      id: 1004,
      betNumber: '1004',
      betType: 'SINGLE',
      ...
      market: 'Mais de 2.5',
      winner: '',
      analysis: '🇵🇹 Portugal vs Croácia 🇭🇷 Mais de 2.5 Golos @1.95 — Portugal tem um ataque devastador com Ronaldo e Bruno Fernandes. A Croácia de Modric prefere jogar em transição mas tem capacidade ofensiva. Os últimos 3 confrontos entre estas equipas produziram 3+ golos. Esperamos um jogo aberto com golos de ambos os lados.',
      homePercent: 48,
      drawPercent: 27,
      awayPercent: 25,
    },
    // ===== ANÁLISE ANTECIPADA: ESPANHA vs ÁUSTRIA (2 JUL) =====
    {
      id: 1005,
      betNumber: '1005',
      betType: 'SINGLE',
      ...
      market: 'Resultado Final',
      winner: 'Espanha',
      analysis: '🇪🇸 Espanha vs Áustria 🇦🇹 Vitória Espanha @1.40 — A Espanha de Lamine Yamal e Pedri é uma das equipas mais dominantes do torneio. A Áustria surpreendeu ao qualificar-se mas a diferença de qualidade é clara. O estilo de posse de bola espanhol deverá ser demasiado para a Áustria. Uma vitória espanhola é o resultado mais seguro.',
      homePercent: 70,
      drawPercent: 18,
      awayPercent: 12,
    },
    // ===== ACUMULADOR DO DIA =====
    {
      ...
      date: dateStr,
      time: '17:00',
      prediction: 'Inglaterra Vence & +1.5 Golos + EUA Vence',
      confidence: 82,
      odds: 2.25,
      market: 'Combinada',
      winner: '',
      analysis: '🔥 ACUMULADOR DO DIA 🔥\n\n1️⃣ Inglaterra Vence & +1.5 Golos vs Congo-DR @1.45\n2️⃣ EUA Vence vs Bósnia-Herzegovina @1.55\n\nOdd Total: @2.25 💰\n\nA Inglaterra é grande favorita em casa contra o Congo-DR e esperamos uma vitória confortável. Os EUA jogam em casa e têm o apoio do público. Dois resultados muito prováveis combinados num acumulador com excelente valor.',
      homePercent: 0,
      drawPercent: 0,
      awayPercent: 0,
    }
