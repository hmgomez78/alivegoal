...
// Fallback tips — 10/07/2026 — Quartos de Final Mundial 2026: Espanha vs Bélgica
function getFallbackTips(): Tip[] {
  const today = new Date();
  const dateStr = today.toLocaleDateString('pt-PT', { day: '2-digit', month: '2-digit' });
  return [
    // ===== MUNDIAL 2026 QUARTOS: ESPANHA vs BELGICA — Vitória Espanha =====
    {
      id: 5020,
      betNumber: '5020',
      betType: 'SINGLE',
      league: 'FIFA Mundial 2026 - Quartos de Final',
      homeTeam: 'Espanha',
      awayTeam: 'Bélgica',
      date: dateStr,
      time: '20:00',
      ...
      winner: 'Espanha',
      analysis: '🇪🇸 Espanha vs Bélgica — Vitória Espanha @1.70 — A Espanha é a equipa mais dominante deste Mundial: zero golos sofridos em 4 jogos, posse de bola acima de 65% em todos os jogos e Lamine Yamal em estado de graça com 5 golos e 3 assistências. A Bélgica tem qualidade individual mas é uma equipa em transição geracional. Rodri controla o meio-campo e Yamal destrói qualquer defesa. Espanha deverá vencer com autoridade.',
      homePercent: 60,
      drawPercent: 20,
      awayPercent: 20,
    },
    // ===== MUNDIAL 2026 QUARTOS: ESPANHA vs BELGICA — Menos de 2.5 Golos =====
    {
      id: 5021,
      betNumber: '5021',
      betType: 'SINGLE',
      ...
      market: 'Mais de 2.5',
      winner: '',
      analysis: '🛡️ Espanha vs Bélgica — Menos de 2.5 Golos @1.80 — A Espanha não sofreu um único golo em todo o torneio, demonstrando uma solidez defensiva extraordinária. A Bélgica, apesar do ataque com De Bruyne e Doku, tem tido dificuldades a criar oportunidades claras. Os jogos de Espanha neste Mundial têm sido controlados e com poucos golos. Esperamos um jogo fechado com no máximo 2 golos.',
      homePercent: 60,
      drawPercent: 20,
      awayPercent: 20,
    },
    // ===== MUNDIAL 2026 QUARTOS: ESPANHA vs BELGICA — Lamine Yamal Marca =====
    {
      id: 5022,
      betNumber: '5022',
      betType: 'SINGLE',
      ...
      date: dateStr,
      time: '20:00',
      prediction: 'Lamine Yamal a Marcar',
      confidence: 65,
      odds: 2.40,
      market: 'Resultado Final',
      winner: 'Espanha',
      analysis: '⭐ Lamine Yamal a Marcar @2.40 — O prodígio espanhol de 18 anos é o melhor jogador do torneio com 5 golos e 3 assistências. Yamal tem marcado ou assistido em todos os jogos da Espanha neste Mundial. A Bélgica terá dificuldades em travar o extremo do Barcelona, que joga com uma liberdade e criatividade únicas. Uma aposta de valor para quem acredita na estrela do torneio.',
      homePercent: 60,
      drawPercent: 20,
      awayPercent: 20,
    },
    // ===== QUALIFICAÇÃO CONFERENCE LEAGUE: BOHEMIANS vs ST JOSEPHS =====
    {
      id: 5023,
      betNumber: '5023',
      betType: 'SINGLE',
      ...
      homeTeam: 'Bohemians',
      awayTeam: "St. Joseph's",
      date: dateStr,
      time: '18:00',
      prediction: "Vitória Bohemians",
      confidence: 85,
      odds: 1.25,
      market: 'Resultado Final',
      winner: 'Bohemians',
      analysis: "🇮🇪 Bohemians vs St. Joseph's — Vitória Bohemians @1.25 — Os Bohemians de Dublin são uma das equipas mais tradicionais da Irlanda e têm experiência nas competições europeias. O St. Joseph's de Gibraltar é claramente inferior em qualidade e recursos. Jogando no Dalymount Park em Dublin, os Bohemians deverão vencer com facilidade nesta 1ª mão da qualificação.",
      homePercent: 78,
      drawPercent: 14,
      awayPercent: 8,
    },
    // ===== QUALIFICAÇÃO CONFERENCE LEAGUE: MARSAXLOKK vs PYUNIK =====
    {
      id: 5024,
      betNumber: '5024',
      betType: 'SINGLE',
      ...
      date: dateStr,
      time: '18:00',
      prediction: 'Vitória Pyunik',
      confidence: 80,
      odds: 1.55,
      market: 'Resultado Final',
      winner: 'Pyunik',
      analysis: '🇦🇲 Marsaxlokk vs Pyunik — Vitória Pyunik @1.55 — O Pyunik de Erevan é o clube mais titulado da Arménia e tem participado regularmente nas qualificações europeias. O Marsaxlokk de Malta é claramente inferior em qualidade. Apesar de jogar fora, o Pyunik tem a qualidade e experiência necessárias para vencer nesta 1ª mão da qualificação para a Conference League.',
      homePercent: 20,
      drawPercent: 22,
      awayPercent: 58,
    },
    // ===== ACUMULADOR DO DIA (DOUBLE) — MUNDIAL + EUROPA =====
    {
      id: 5025,
      betNumber: '5025',
      betType: 'DOUBLE',
      league: 'Mundial 2026 + Qualificacoes Europeias',
      homeTeam: 'Espanha + Pyunik',
      awayTeam: 'Multipla',
      date: dateStr,
      time: '18:00',
      prediction: 'Vitória Espanha + Vitória Pyunik',
      confidence: 74,
      odds: 2.64,
      market: 'Combinada',
      winner: '',
      analysis: '🔥 ACUMULADOR DO DIA @2.64 — Combinamos a grande favorita do dia no Mundial com o favorito nas qualificações europeias. A Espanha é a equipa mais dominante do torneio e não sofreu um único golo. O Pyunik tem qualidade superior ao Marsaxlokk maltês. Uma dupla de valor com odds atrativas que combina o glamour dos quartos de final com a segurança das qualificações europeias.',
      homePercent: 55,
      drawPercent: 0,
      awayPercent: 45,
    }
