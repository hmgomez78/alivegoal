...
function parseTipsFromHTML(html: string): Tip[] {
  ...
  const todayStr = today.toISOString().split('T')[0]; // e.g. "2026-06-23"
...
function getFallbackTips(): Tip[] {
  ...
  return [
    // ===== MUNDIAL 2026 GRUPO B: SUÍÇA vs CANADÁ =====
    {
      ...
      date: dateStr,
      time: '20:00',
      prediction: 'Empate ou Canadá',
      confidence: 78,
      odds: 1.75,
      market: 'Dupla Hipótese',
      winner: '',
      analysis: '🇨🇭 Suíça vs Canadá 🇨🇦 Dupla Hipótese X2 @1.75 — O Canadá tem sido a grande surpresa do Grupo B, vindo de uma impressionante goleada de 6-0 sobre o Qatar, após um empate inicial. A Suíça também goleou a Bósnia, mas o Canadá mostrou uma intensidade ofensiva superior. Com ambas as equipas com 4 pontos, um empate pode servir a ambas, mas o Canadá tem a vantagem do fator casa (jogo em Vancouver) e do ímpeto.',
      homePercent: 35,
      drawPercent: 35,
      awayPercent: 30,
    },
    // ===== MUNDIAL 2026 GRUPO C: ESCÓCIA vs BRASIL =====
    {
      id: 988,
      betNumber: '988',
      betType: 'SINGLE',
      ...
      date: dateStr,
      time: '23:00',
      prediction: 'Vitória Brasil & Over 1.5 Golos',
      confidence: 85,
      odds: 1.45,
      market: 'Resultado Final',
      winner: 'Brasil',
      analysis: '🏴󠁧󠁢󠁳󠁣󠁴󠁿 Escócia vs Brasil 🇧🇷 Vitória Brasil + Over 1.5 @1.45 — O Brasil lidera o Grupo C após uma vitória convincente por 3-0 sobre o Haiti e um empate inicial com Marrocos. A Escócia, apesar da sua garra, vem de uma derrota contra Marrocos e precisa de arriscar para se qualificar, o que abrirá espaços na defesa. A qualidade individual do ataque brasileiro, com Vinícius Jr e Rodrygo, deverá explorar essas lacunas.',
      homePercent: 15,
      drawPercent: 20,
      awayPercent: 65,
    },
    // ===== MUNDIAL 2026 GRUPO C: MARROCOS vs HAITI =====
    {
      id: 989,
      betNumber: '989',
      betType: 'SINGLE',
      ...
      date: dateStr,
      time: '23:00',
      prediction: 'Vitória Marrocos ao Intervalo',
      confidence: 82,
      odds: 1.65,
      market: 'Resultado ao Intervalo',
      winner: 'Marrocos',
      analysis: '🇲🇦 Marrocos vs Haiti 🇭🇹 Marrocos Vence 1ª Parte @1.65 — O Marrocos é claramente superior ao Haiti e vai querer resolver o jogo cedo para garantir a qualificação e gerir o esforço físico. O Haiti sofreu 3 golos do Brasil e 1 da Escócia, demonstrando fragilidades defensivas evidentes. A intensidade inicial da equipa marroquina deverá ser suficiente para ir para o intervalo já em vantagem.',
      homePercent: 75,
      drawPercent: 15,
      awayPercent: 10,
    },
    // ===== MUNDIAL 2026 GRUPO B: BÓSNIA vs QATAR =====
    {
      id: 990,
      betNumber: '990',
      betType: 'SINGLE',
      ...
      market: 'Ambas Marcam',
      winner: '',
      analysis: '🇧🇦 Bósnia vs Qatar 🇶🇦 Ambas Marcam @1.95 — Um jogo entre duas equipas que precisam desesperadamente de pontos. A Bósnia sofreu 4 golos da Suíça, enquanto o Qatar foi humilhado por 6-0 pelo Canadá. Ambas as defesas são extremamente permeáveis, mas também têm capacidade de marcar contra adversários do mesmo nível (ambas empataram 1-1 na primeira jornada). Jogo aberto e com oportunidades para os dois lados.',
      homePercent: 45,
      drawPercent: 25,
      awayPercent: 30,
    },
    // ===== BRASILEIRÃO SÉRIE A: SÃO PAULO vs FLAMENGO =====
    {
      id: 991,
      betNumber: '991',
      betType: 'SINGLE',
      ...
      market: 'Menos de 2.5',
      winner: '',
      analysis: '🇧🇷 São Paulo vs Flamengo 🇧🇷 Menos de 2.5 Golos @1.70 — Um clássico tenso no Morumbi. O São Paulo de Zubeldía tem sido muito sólido defensivamente em casa, enquanto o Flamengo, apesar do talento ofensivo, tem tido dificuldades em jogos grandes fora de portas. Historicamente, os confrontos recentes entre estas equipas têm sido muito táticos e com poucos golos. Prevemos um jogo muito fechado.',
      homePercent: 35,
      drawPercent: 35,
      awayPercent: 30,
    },
    // ===== ACUMULADOR DO DIA =====
    {
      ...
      betNumber: '992',
      betType: 'DOUBLE',
      league: 'Acumulador Mundial 2026',
      homeTeam: 'Múltiplos',
      awayTeam: 'Jogos',
      date: dateStr,
      time: '20:00',
      prediction: 'Brasil + Marrocos (Vitórias) + Canadá (X2)',
      confidence: 85,
      odds: 2.85,
      market: 'Combinada',
      winner: '',
      analysis: '🔥 ACUMULADOR DO MUNDIAL 🔥\n\n1️⃣ Brasil a Vencer (vs Escócia)\n2️⃣ Marrocos a Vencer (vs Haiti)\n3️⃣ Canadá ou Empate (vs Suíça)\n\nOdd Total: @2.85 💰\n\nBrasil e Marrocos são amplamente favoritos contra equipas inferiores técnica e taticamente. O Canadá joga em casa, vem motivado por uma goleada de 6-0 e dificilmente perderá contra a Suíça num jogo onde o empate pode até servir às duas equipas.',
      homePercent: 0,
      drawPercent: 0,
      awayPercent: 0,
    }
