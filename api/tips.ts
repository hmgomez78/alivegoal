...
// Fallback tips — 29/06/2026 — Oitavos de Final
function getFallbackTips(): Tip[] {
  const dateStr = '29/06/2026';
  return [
    // ===== OITAVOS DE FINAL: BRASIL vs JAPÃO =====
    {
      id: 1001,
      betNumber: '1001',
      betType: 'SINGLE',
      ...
      winner: 'Brasil',
      analysis: '🇧🇷 Brasil vs Japão 🇯🇵 Vitória Brasil @1.45 — O Brasil é claro favorito contra o Japão. Com Vini Jr e Rodrygo em boa forma, a seleção canarinha tem demasiado poder de fogo para a defesa nipónica. O Japão surpreendeu na fase de grupos, mas a qualidade individual do Brasil deve prevalecer num jogo a eliminar.',
      homePercent: 70,
      drawPercent: 20,
      awayPercent: 10,
    },
    // ===== OITAVOS DE FINAL: ALEMANHA vs PARAGUAI =====
    {
      id: 1002,
      betNumber: '1002',
      betType: 'SINGLE',
      ...
      date: dateStr,
      time: '21:30',
      prediction: 'Alemanha Vence & Mais de 1.5 Golos',
      confidence: 80,
      odds: 1.65,
      market: 'Resultado & Golos',
      winner: 'Alemanha',
      analysis: '🇩🇪 Alemanha vs Paraguai 🇵🇾 Alemanha Vence & +1.5 Golos @1.65 — A Alemanha de Musiala e Wirtz tem mostrado um futebol ofensivo forte. O Paraguai defende bem, mas a máquina alemã costuma ser implacável nestas fases. Esperamos uma vitória alemã com pelo menos dois golos no jogo.',
      homePercent: 65,
      drawPercent: 25,
      awayPercent: 10,
    },
    // ===== OITAVOS DE FINAL: HOLANDA vs MARROCOS =====
    {
      id: 1003,
      betNumber: '1003',
      betType: 'SINGLE',
      ...
      market: 'Ambas Marcam',
      winner: '',
      analysis: '🇳🇱 Holanda vs Marrocos 🇲🇦 Ambas Marcam @1.95 — Um dos jogos mais equilibrados dos oitavos. A Holanda tem um ataque rápido com Gakpo e Simons, mas Marrocos mostrou em 2022 que sabe jogar estas fases e tem jogadores como Ziyech e Hakimi. Jogo aberto onde as duas equipas têm capacidade para marcar.',
      homePercent: 45,
      drawPercent: 30,
      awayPercent: 25,
    },
    // ===== OITAVOS DE FINAL: INGLATERRA vs CONGO-DR (análise antecipada) =====
    {
      ...
      market: 'Resultado Final',
      winner: 'Inglaterra',
      analysis: '🏴󠁧󠁢󠁥󠁮󠁧󠁿 Inglaterra vs Congo-DR 🇨🇩 Vitória Inglaterra @1.35 — A Inglaterra de Bellingham e Kane, vencedora do Grupo L, defronta um Congo-DR que fez história ao qualificar-se. A diferença de qualidade é enorme. A Inglaterra tem motivação extra após o recorde de Kane. Uma vitória inglesa é o resultado mais provável.',
      homePercent: 75,
      drawPercent: 15,
      awayPercent: 10,
    },
    // ===== OITAVOS DE FINAL: PORTUGAL vs CROÁCIA (análise antecipada) =====
    {
      ...
      market: 'Resultado Final',
      winner: '',
      analysis: '🇵🇹 Portugal vs Croácia 🇭🇷 Empate @3.20 — Jogo muito tático em perspetiva. Portugal desiludiu contra a Colômbia e a Croácia é mestre em levar jogos a eliminar para prolongamento. Com meios-campos muito fortes de ambos os lados, prevemos um jogo fechado que pode não se resolver nos 90 minutos.',
      homePercent: 40,
      drawPercent: 35,
      awayPercent: 25,
    },
    // ===== ACUMULADOR DO DIA =====
    {
      ...
      date: dateStr,
      time: '18:00',
      prediction: 'Brasil Vence + Alemanha Vence',
      confidence: 82,
      odds: 2.39,
      market: 'Combinada',
      winner: '',
      analysis: '🔥 ACUMULADOR DOS OITAVOS 🔥\n\n1️⃣ Brasil Vence vs Japão @1.45\n2️⃣ Alemanha Vence vs Paraguai @1.65\n\nOdd Total: @2.39 💰\n\nBrasil e Alemanha são os claros favoritos nos seus respetivos jogos. Ambas as seleções têm qualidade superior e tradição em fases a eliminar. Uma aposta dupla sólida para abrir os oitavos de final.',
      homePercent: 0,
      drawPercent: 0,
      awayPercent: 0,
    }
