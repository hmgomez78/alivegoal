...
function getFallbackTips(): Tip[] {
  ...
  return [
    // ===== MUNDIAL 2026 GRUPO L: INGLATERRA vs PANAMÁ =====
    {
      id: 993,
      betNumber: '993',
      betType: 'SINGLE',
      ...
      market: 'Mais de 2.5',
      winner: '',
      analysis: '🏴️‍🏴️ Inglaterra vs Panamá 🇵🇦 Mais de 2.5 Golos @1.65 — A Inglaterra de Jude Bellingham, já apurada, enfrenta um Panamá que precisa de vencer para ter hipótese de apuramento. Os ingleses marcaram 4 golos na estreia contra a Croácia e têm um ataque devastador com Bellingham, Saka e Foden. O Panamá vai atacar por necessidade, criando espaços para o contra-ataque inglês. Um jogo com golos garantidos dos dois lados.',
      homePercent: 65,
      drawPercent: 20,
      awayPercent: 15,
    },
    // ===== MUNDIAL 2026 GRUPO L: CROÁCIA vs GANA =====
    {
      id: 994,
      betNumber: '994',
      betType: 'SINGLE',
      ...
      date: dateStr,
      time: '22:00',
      prediction: 'Croácia Vence ou Empate',
      confidence: 76,
      odds: 1.50,
      market: 'Dupla Hipótese',
      winner: 'Croácia',
      analysis: '🇭🇷 Croácia vs Gana 🇬🇭 Dupla Hipótese 1X @1.50 — A Croácia de Modric precisa de pontos para garantir a qualificação. A equipa croata tem experiência de Mundiais (finalista em 2018) e não deverá perder para o Gana. O Gana tem jogadores de qualidade como Jordan Ayew, mas a Croácia tem mais experiência e solidez defensiva. Uma vitória ou empate croata é o resultado mais provável.',
      homePercent: 45,
      drawPercent: 30,
      awayPercent: 25,
    },
    // ===== MUNDIAL 2026 GRUPO K: PORTUGAL vs COLÔMBIA =====
    {
      id: 995,
      betNumber: '995',
      betType: 'SINGLE',
      ...
      date: dateStr,
      time: '00:30',
      prediction: 'Portugal Vence',
      confidence: 72,
      odds: 1.95,
      market: 'Resultado Final',
      winner: 'Portugal',
      analysis: '🇵🇹 Portugal vs Colômbia 🇨🇴 Vitória Portugal @1.95 — Cristiano Ronaldo e Portugal defrontam a Colômbia de James Rodríguez num duelo de gigantes pelo topo do Grupo K. Portugal empatou com o Congo-DR na estreia e precisa de vencer para garantir o primeiro lugar. A Colômbia venceu o Uzbequistão por 3-1 e está em excelente forma. Ronaldo vai querer marcar o seu primeiro golo do torneio. Portugal tem mais qualidade individual e deve vencer.',
      homePercent: 48,
      drawPercent: 27,
      awayPercent: 25,
    },
    // ===== MUNDIAL 2026 GRUPO J: JORDÂNIA vs ARGENTINA =====
    {
      ...
      market: 'Resultado Final',
      winner: 'Argentina',
      analysis: '🇯🇴 Jordânia vs Argentina 🇦🇷 Vitória Argentina @1.30 — Lionel Messi e a Argentina, camió do mundo, enfrentam a Jordânia num jogo que deverá ser de gestão para os sul-americanos. A Argentina venceu a Argélia por 3-0 na estreia com hat-trick de Messi e está em excelente forma. A Jordânia perdeu para a Áustria e tem muito menos qualidade. Uma vitória argentina é praticamente certa.',
      homePercent: 10,
      drawPercent: 15,
      awayPercent: 75,
    },
    // ===== MUNDIAL 2026 GRUPO K: CONGO-DR vs UZBEQUISTÃO =====
    {
      id: 997,
      betNumber: '997',
      betType: 'SINGLE',
      ...
      market: 'Ambas Marcam',
      winner: '',
      analysis: '🇨🇩 Congo-DR vs Uzbequistão 🇺🇿 Ambas Marcam @1.85 — Jogo de vida ou morte para ambas as equipas! O Congo-DR empatou com Portugal e precisa de vencer para ter hipótese de qualificação. O Uzbequistão perdeu para a Colômbia por 3-1 mas tem jogadores de qualidade. Ambas as equipas vão atacar com tudo, criando condições ideais para golos dos dois lados. Um jogo aberto com golos garantidos.',
      homePercent: 40,
      drawPercent: 28,
      awayPercent: 32,
    },
    // ===== ACUMULADOR DO DIA =====
    {
      ...
      betNumber: '998',
      betType: 'DOUBLE',
      league: 'Acumulador Mundial 2026 — Dia 17',
      homeTeam: 'Múltiplos',
      awayTeam: 'Jogos',
      date: dateStr,
      time: '22:00',
      prediction: 'Mais 2.5 Golos (Inglaterra-Panamá) + Portugal Vence + Argentina Vence',
      confidence: 81,
      odds: 3.20,
      market: 'Combinada',
      winner: '',
      analysis: '🔥 ACUMULADOR DO DIA 17 🔥\n\n1️⃣ Mais de 2.5 Golos (Inglaterra vs Panamá) @1.65\n2️⃣ Portugal Vence vs Colômbia @1.95\n3️⃣ Argentina Vence vs Jordânia @1.30\n\nOdd Total: @3.20 💰\n\nInglaterra tem um ataque devastador e o Panamá vai atacar por necessidade — golos garantidos. Portugal precisa de vencer e tem qualidade para isso contra a Colômbia. Argentina é a camió do mundo e não deverá perder para a Jordânia. Uma combinação de alto valor e confiabilidade para o Dia 17.',
      homePercent: 0,
      drawPercent: 0,
      awayPercent: 0,
    }
