...
function getFallbackTips(): Tip[] {
  ...
  return [
    ...
    },
    {
      ...
      market: 'Menos de 2.5',
      winner: '',
      analysis: `A Juventus defronta o Nice num encontro de preparação. Com a vitória italiana avaliada em 1.57, o mercado espera algum domínio da equipa da Serie A, mas os amigáveis das equipas italianas nesta fase costumam ser de ritmo controlado. O Under 2.5 golos oferece uma abordagem de valor. ${RESPONSIBLE_GAMBLING_NOTE}`,
      homePercent: 43,
      drawPercent: 33,
      awayPercent: 24,
    },
