...
// Fallback tips — 03/07/2026 — 16 Avos de Final (Argentina, Colômbia, Austrália)
function getFallbackTips(): Tip[] {
  const dateStr = '03/07/2026';
  return [
    // ===== 16 AVOS DE FINAL: ARGENTINA vs CABO VERDE =====
    {
      id: 2001,
      betNumber: '2001',
      betType: 'SINGLE',
      ...
      winner: 'Argentina',
      analysis: '🇦🇷 Argentina vs Cabo Verde 🇨🇻 Vitória Argentina @1.22 — Os campeões do mundo são favoritos esmagadores neste confronto. Messi, Lautaro Martínez e Mac Allister formam um trio de classe mundial que Cabo Verde não consegue travar durante 90 minutos. A Argentina cobriu -1.5 em 8 dos últimos 9 jogos e tem 8 clean sheets nos últimos 10. Cabo Verde tem uma organização defensiva sólida (só sofreu 2 golos na fase de grupos), mas a qualidade argentina é demasiado superior. Esperamos uma vitória confortável dos campeões do mundo.',
      homePercent: 82,
      drawPercent: 14,
      awayPercent: 4,
    },
    // ===== 16 AVOS DE FINAL: ARGENTINA vs CABO VERDE — UNDER =====
    {
      id: 2002,
      betNumber: '2002',
      betType: 'SINGLE',
      ...
      market: 'Mais de 2.5',
      winner: '',
      analysis: '🇦🇷 Argentina vs Cabo Verde — Under 2.5 Golos @1.90 — Apesar de a Argentina ser favorita esmagadora, o estilo de jogo de Cabo Verde (bloco baixo, 4-5-1 compacto) pode limitar o número de golos. A Argentina não precisa de marcar muitos golos para avançar. Cabo Verde só sofreu 2 golos em 3 jogos na fase de grupos. A Argentina também não tem pressa e prefere controlar o jogo. Um resultado de 2-0 ou 1-0 é o cenário mais provável, o que significa Under 2.5. Excelente valor a odds positivas (+125 em algumas casas).',
      homePercent: 82,
      drawPercent: 14,
      awayPercent: 4,
    },
    // ===== 16 AVOS DE FINAL: COLÔMBIA vs GANA =====
    {
      id: 2003,
      betNumber: '2003',
      betType: 'SINGLE',
      ...
      date: dateStr,
      time: '02:30',
      prediction: 'Colômbia Vence',
      confidence: 78,
      odds: 1.65,
      market: 'Resultado Final',
      winner: 'Colômbia',
      analysis: '🇨🇴 Colômbia vs Gana 🇬🇭 Vitória Colômbia @1.65 — A Colômbia foi uma das equipas mais impressionantes da fase de grupos, terminando em 1º lugar com 7 pontos. O trio ofensivo Luis Díaz, James Rodriguez e Luis Suárez é elétrico. Gana qualificou-se como terceiro classificado e gerou apenas 2.06 xG em 3 jogos (o mais baixo de todos). Carlos Queiroz é um treinador defensivo e pode jogar pelos penáltis desde o início. A Colômbia só perdeu 2 dos últimos 16 jogos internacionais. Uma vitória colombiana é o resultado mais provável.',
      homePercent: 62,
      drawPercent: 22,
      awayPercent: 16,
    },
    // ===== 16 AVOS DE FINAL: AUSTRÁLIA vs EGITO =====
    {
      id: 2004,
      betNumber: '2004',
      betType: 'SINGLE',
      ...
      market: 'Ambas Marcam',
      winner: '',
      analysis: '🇦🇺 Austrália vs Egito 🇪🇬 Ambas Marcam @1.85 — Este é o jogo mais equilibrado do dia. A Austrália tem um ataque dinâmico com Mathew Leckie e tem marcado em todos os jogos do torneio. O Egito, com Mohamed Salah em forma, tem também capacidade ofensiva. Ambas as equipas precisam de vencer para avançar e isso cria um jogo aberto. O Egito marcou em 4 dos últimos 5 jogos internacionais. Esperamos um jogo com golos de ambos os lados, tornando Ambas Marcam uma aposta com bom valor.',
      homePercent: 45,
      drawPercent: 28,
      awayPercent: 27,
    },
    // ===== ANÁLISE: COLÔMBIA — HANDICAP ASIÁTICO =====
    {
      id: 2005,
      betNumber: '2005',
      betType: 'SINGLE',
      ...
      date: dateStr,
      time: '02:30',
      prediction: 'Colômbia Vence & Mais de 1.5 Golos',
      confidence: 70,
      odds: 2.05,
      market: 'Combinada',
      winner: 'Colômbia',
      analysis: '🇨🇴 Colômbia vs Gana — Vitória Colômbia & +1.5 Golos @2.05 — A Colômbia é a equipa com melhor média de posse de bola do torneio (60%) e tem os full-backs mais ofensivos do Mundial. Daniel Muñoz já marcou 2 golos. Gana vai defender em bloco baixo mas a qualidade colombiana deve ser suficiente para marcar pelo menos 2 golos. A combinação de vitória colombiana com pelo menos 2 golos no total oferece excelente valor a @2.05. Uma aposta de valor para quem acredita na qualidade colombiana.',
      homePercent: 62,
      drawPercent: 22,
      awayPercent: 16,
    },
    // ===== ACUMULADOR DO DIA =====
    {
      ...
      date: dateStr,
      time: '19:00',
      prediction: 'Argentina Vence + Colômbia Vence',
      confidence: 82,
      odds: 2.01,
      market: 'Combinada',
      winner: '',
      analysis: '🔥 ACUMULADOR DO DIA 🔥\n\n1️⃣ Argentina Vence vs Cabo Verde @1.22\n2️⃣ Colômbia Vence vs Gana @1.65\n\nOdd Total: @2.01 💰\n\nA Argentina é a equipa mais forte do torneio e Messi está em grande forma. Uma vitória argentina contra Cabo Verde é quase garantida. A Colômbia foi uma das equipas mais impressionantes da fase de grupos e Gana é um adversário acessível. Dois resultados muito prováveis combinados num acumulador com retorno de mais de 2x. A melhor aposta do dia para quem quer maximizar o retorno com segurança!',
      homePercent: 0,
      drawPercent: 0,
      awayPercent: 0,
    }
