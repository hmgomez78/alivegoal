...
function getFallbackTips(): Tip[] {
  ...
  return [
    // ===== MUNDIAL 2026 GRUPO K: PORTUGAL vs UZBEQUISTÃO =====
    {
      ...
      date: dateStr,
      time: '18:00',
      prediction: 'Vitória Portugal & Over 2.5 Golos',
      confidence: 84,
      odds: 1.55,
      market: 'Resultado Final',
      winner: 'Portugal',
      analysis: '🇵🇹 Portugal Vitória + Over 2.5 @1.55 — Portugal precisa urgentemente de vencer após o empate frustrante com o Congo DR. Com Rúben Dias de regresso e Bruno Fernandes a assumir o comando, os lusos têm qualidade mais que suficiente para golear o Uzbequistão, que perdeu 3-1 com a Colômbia. O Uzbequistão tem debilidades defensivas e Portugal vai atacar desde o apito inicial para recuperar a confiança e a diferença de golos.',
      homePercent: 75,
      drawPercent: 15,
      awayPercent: 10,
    },
    // ===== MUNDIAL 2026 GRUPO L: INGLATERRA vs GANA =====
    {
      id: 988,
      betNumber: '988',
      betType: 'SINGLE',
      ...
      date: dateStr,
      time: '21:00',
      prediction: 'Vitória Inglaterra',
      confidence: 83,
      odds: 1.35,
      market: 'Resultado Final',
      winner: 'Inglaterra',
      analysis: '🏴󠁧󠁢󠁥󠁮󠁧󠁿 Inglaterra Vitória @1.35 — A Inglaterra entrou em grande no Mundial com uma vitória por 4-2 sobre a Croácia, com Harry Kane a bisar. O Gana, apesar de ter vencido o Panamá (1-0), mostrou limitações ofensivas com apenas 2 remates ao alvo. Tuchel tem uma equipa talentosa com Bellingham, Saka e Rashford, e a qualidade individual dos ingleses deve ser determinante para garantir os 3 pontos.',
      homePercent: 72,
      drawPercent: 18,
      awayPercent: 10,
    },
    // ===== MUNDIAL 2026 GRUPO L: PANAMÁ vs CROÁCIA =====
    {
      id: 989,
      betNumber: '989',
      betType: 'SINGLE',
      ...
      market: 'Resultado Final',
      winner: 'Croácia',
      analysis: '🇭🇷 Croácia Vitória @1.65 — A Croácia, apesar de ter perdido para a Inglaterra (2-4), mostrou qualidade técnica e tem jogadores experientes como Modric e Kovacic. O Panamá foi derrotado pelo Gana (0-1) e tem dificuldades em criar oportunidades de golo. Com a necessidade de vencer para manter a qualificação em aberto, a Croácia deve impor o seu jogo técnico e conseguir os 3 pontos.',
      homePercent: 25,
      drawPercent: 30,
      awayPercent: 45,
    },
    // ===== MUNDIAL 2026 GRUPO K: COLÔMBIA vs CONGO DR =====
    {
      id: 990,
      betNumber: '990',
      betType: 'SINGLE',
      ...
      market: 'Resultado Final',
      winner: 'Colômbia',
      analysis: '🇨🇴 Colômbia Vitória @1.75 — A Colômbia venceu o Uzbequistão por 3-1 na primeira jornada, com Luis Díaz em grande destaque. O Congo DR, apesar de ter empatado com Portugal (1-1), mostrou ser uma equipa organizada mas com limitações ofensivas. A qualidade técnica de Díaz, James Rodríguez e Falcao deve ser suficiente para garantir os 3 pontos e a liderança do Grupo K.',
      homePercent: 55,
      drawPercent: 25,
      awayPercent: 20,
    },
    // ===== MUNDIAL 2026 GRUPO K: PORTUGAL — OVER 2.5 =====
    {
      id: 991,
      betNumber: '991',
      betType: 'SINGLE',
      ...
      market: 'Mais de 2.5',
      winner: '',
      analysis: '⚽ Over 2.5 @1.60 — Portugal tem o ataque mais poderoso do Grupo K e vai entrar em campo com fome de golos após o empate com o Congo. O Uzbequistão sofreu 3 golos frente à Colômbia e tem debilidades defensivas evidentes, especialmente no lado direito onde Khusanov foi constantemente testado. Esperamos um jogo com pelo menos 3 golos, com Portugal a resolver o encontro antes do intervalo.',
      homePercent: 75,
      drawPercent: 15,
      awayPercent: 10,
    },
    // ===== ACUMULADOR (DOUBLE) — DIA 13 DO MUNDIAL =====
    {
      id: 992,
      betNumber: '992',
      betType: 'DOUBLE',
      ...
      market: 'Acumulador',
      winner: '',
      analysis: '💰 ACUMULADOR DO DIA @2.09 — Combinamos as duas seleções europeias favoritas do dia. Portugal (@1.55) precisa de vencer para manter a qualificação e tem qualidade para golear o Uzbequistão. A Inglaterra (@1.35) é a grande favorita frente ao Gana e vem de uma exibição impressionante. Juntas, estas duas vitórias oferecem uma odd combinada de 2.09, ideal para dobrar o investimento com elevada probabilidade de sucesso.',
      homePercent: 0,
      drawPercent: 0,
      awayPercent: 0,
    }
