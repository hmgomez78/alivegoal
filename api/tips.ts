...
function getFallbackTips(): Tip[] {
  ...
  return [
    // ===== MUNDIAL 2026 GRUPO I: FRANÇA vs NORUEGA =====
    {
      ...
      market: 'Mais de 2.5',
      winner: '',
      analysis: '🇫🇷 França vs Noruega 🇳🇴 Mais de 2.5 Golos @1.80 — O duelo mais esperado do Mundial! Mbappé (4 golos) vs Haaland (4 golos) num jogo entre duas das melhores ataques do torneio. A França marcou 6 golos em 2 jogos, a Noruega marcou 7. Ambas as equipas já estão apuradas e vão jogar com liberdade ofensiva para decidir o primeiro lugar do grupo. Um jogo com golos garantidos.',
      homePercent: 45,
      drawPercent: 25,
      awayPercent: 30,
    },
    // ===== MUNDIAL 2026 GRUPO H: ESPANHA vs URUGUAI =====
    {
      id: 994,
      betNumber: '994',
      betType: 'SINGLE',
      ...
      date: dateStr,
      time: '01:00',
      prediction: 'Espanha Vence ou Empate',
      confidence: 79,
      odds: 1.55,
      market: 'Dupla Hipótese',
      winner: 'Espanha',
      analysis: '🇪🇸 Espanha vs Uruguai 🇺🇾 Dupla Hipótese 1X @1.55 — A Espanha de Lamine Yamal já está apurada e lidera o Grupo H. O Uruguai precisa de vencer para garantir a qualificação, mas a Espanha é claramente superior em termos de qualidade individual e coletiva. Com Yamal, Pedri e Morata em forma, a Espanha não deverá perder este jogo. O Uruguai tem Darwin Núñez e Valverde, mas a defesa espanhola é muito sólida.',
      homePercent: 50,
      drawPercent: 25,
      awayPercent: 25,
    },
    // ===== MUNDIAL 2026 GRUPO G: EGITO vs IRÃ =====
    {
      id: 995,
      betNumber: '995',
      betType: 'SINGLE',
      ...
      date: dateStr,
      time: '04:00',
      prediction: 'Egito Vence',
      confidence: 75,
      odds: 2.10,
      market: 'Resultado Final',
      winner: 'Egito',
      analysis: '🇪🇬 Egito vs Irã 🇮🇷 Vitória Egito @2.10 — O Egito lidera o Grupo G após a sua primeira vitória histórica num Mundial (3-1 sobre a Nova Zelândia). Uma vitória garante o primeiro lugar do grupo. O Irã tem apenas 2 pontos (empates com Bélgica e Nova Zelândia) e precisa de vencer, mas a sua defesa tem sido sólida. O Egito tem a qualidade individual e a motivação para fechar o grupo em primeiro.',
      homePercent: 45,
      drawPercent: 30,
      awayPercent: 25,
    },
    // ===== MUNDIAL 2026 GRUPO G: NOVA ZELÂNDIA vs BÉLGICA =====
    {
      id: 996,
      betNumber: '996',
      betType: 'SINGLE',
      ...
      market: 'Ambas Marcam',
      winner: '',
      analysis: '🇳🇿 Nova Zelândia vs Bélgica 🇧🇪 Ambas Marcam @1.90 — Jogo de vida ou morte para a Bélgica! Os belgas têm 2 pontos e precisam de vencer para terem hipotese de qualificação. A Nova Zelândia também precisa de vencer para ter hipotese de apuramento como melhor terceiro. Ambas as equipas vão atacar com tudo, o que cria condições ideais para golos dos dois lados. De Bruyne e companhia têm qualidade suficiente para marcar.',
      homePercent: 30,
      drawPercent: 25,
      awayPercent: 45,
    },
    // ===== MUNDIAL 2026 GRUPO I: SENEGAL vs IRAQUE =====
    {
      id: 997,
      betNumber: '997',
      betType: 'SINGLE',
      ...
      date: dateStr,
      time: '20:00',
      prediction: 'Senegal Vence',
      confidence: 73,
      odds: 1.85,
      market: 'Resultado Final',
      winner: 'Senegal',
      analysis: '🇸🇳 Senegal vs Iraque 🇮🇶 Vitória Senegal @1.85 — Jogo entre duas equipas eliminadas que precisam de vencer para ter qualquer hipotese de apuramento como melhor terceiro. O Senegal, com Sadio Mané e Ismaila Sarr, tem mais qualidade individual e experiência internacional. O Iraque tem sido surpreendente mas enfrenta um adversario de maior calibre. Uma vitória do Senegal parece o resultado mais provável neste confronto direto.',
      homePercent: 50,
      drawPercent: 25,
      awayPercent: 25,
    },
    // ===== ACUMULADOR DO DIA =====
    {
      ...
      betNumber: '998',
      betType: 'DOUBLE',
      league: 'Acumulador Mundial 2026 — Dia 16',
      homeTeam: 'Múltiplos',
      awayTeam: 'Jogos',
      date: dateStr,
      time: '20:00',
      prediction: 'França ou Empate + Espanha ou Empate + Mais 2.5 Golos (França-Noruega)',
      confidence: 83,
      odds: 3.10,
      market: 'Combinada',
      winner: '',
      analysis: '🔥 ACUMULADOR DO DIA 16 🔥\n\n1️⃣ França ou Empate vs Noruega (1X) @1.40\n2️⃣ Espanha ou Empate vs Uruguai (1X) @1.55\n3️⃣ Mais de 2.5 Golos (França vs Noruega) @1.80\n\nOdd Total: @3.10 💰\n\nFrança e Espanha são as duas seleções mais sólidas destes grupos e não deverão perder. O jogo França-Noruega, com Mbappé e Haaland em forma, tem tudo para ser um espetáculo ofensivo com vários golos. Uma combinação de alto valor e confiabilidade.',
      homePercent: 0,
      drawPercent: 0,
      awayPercent: 0,
    }
