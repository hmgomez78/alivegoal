...
function getFallbackTips(): Tip[] {
  ...
  return [
    // ===== MUNDIAL 2026 QUARTOS: FRANCA vs MARROCOS =====
    {
      id: 5010,
      betNumber: '5010',
      betType: 'SINGLE',
      ...
      winner: 'França',
      analysis: '🇫🇷 França vs Marrocos — Vitória França @1.75 — A França chega aos quartos de final como uma das grandes favoritas ao título. Mbappé está em excelente forma e a seleção francesa tem uma profundidade de plantel impressionante. Marrocos é uma equipa organizada e difícil de bater, mas a qualidade individual dos franceses deverá fazer a diferença. A França venceu o confronto de 2022 por 2-0 e está motivada para repetir a façanha.',
      homePercent: 55,
      drawPercent: 22,
      awayPercent: 23,
    },
    // ===== MUNDIAL 2026 QUARTOS: MAIS DE 2.5 GOLOS =====
    {
      id: 5011,
      betNumber: '5011',
      betType: 'SINGLE',
      ...
      market: 'Mais de 2.5',
      winner: '',
      analysis: '⚽ França vs Marrocos — Mais de 2.5 Golos @2.10 — Ambas as equipas têm demonstrado capacidade ofensiva neste Mundial. A França marcou em todos os jogos e Marrocos tem um ataque dinâmico com Ziyech e En-Nesyri. O historial de confrontos entre estas equipas em Mundiais tende a produzir jogos com golos. Uma aposta de valor para quem procura odds mais elevadas.',
      homePercent: 55,
      drawPercent: 22,
      awayPercent: 23,
    },
    // ===== QUALIFICAÇÃO CHAMPIONS LEAGUE: KAIRAT vs SUTJESKA =====
    {
      ...
      analysis: '🏟️ Kairat Almaty vs Sutjeska — Vitória Kairat @1.65 — O Kairat Almaty é o clube mais poderoso do Cazaquistão e tem vasta experiência nas qualificações europeias. Jogando em casa, com o apoio dos seus adeptos, o Kairat deverá impor-se sobre o Sutjeska do Montenegro. A diferença de qualidade entre os dois clubes é significativa, especialmente no ataque.',
      homePercent: 58,
      drawPercent: 22,
      awayPercent: 20,
    },
    // ===== QUALIFICAÇÃO CONFERENCE LEAGUE: CONNAHS vs BALLKANI =====
    {
      id: 5013,
      betNumber: '5013',
      betType: 'SINGLE',
    ...
    // ===== ACUMULADOR DO DIA (DOUBLE) — MUNDIAL + EUROPA =====
    {
      ...
      homeTeam: 'Franca + Ballkani',
      awayTeam: 'Multipla',
      date: dateStr,
      time: '15:00',
      prediction: 'Vitória França + Vitória Ballkani',
      confidence: 72,
      odds: 2.71,
      market: 'Combinada',
      winner: '',
      analysis: '🔥 ACUMULADOR DO DIA @2.71 — Combinamos a favorita do dia no Mundial com o favorito nas qualificações europeias. A França tem classe e experiência para superar Marrocos nos quartos de final. O FC Ballkani é claramente superior ao Connahs Quay galês e deverá vencer com relativa facilidade. Uma dupla de valor que combina o glamour do Mundial com a segurança das qualificações europeias.',
      homePercent: 50,
      drawPercent: 0,
      awayPercent: 50,
    }
